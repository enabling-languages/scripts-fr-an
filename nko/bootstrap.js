...
function startup(data, reason) {
 if (reason == 3 || reason == 5 || reason == 7) {     
  ...
  if (!checkFile.exists()) { 
   ...
   fromFile = fromDir.clone();
   fromFile.append("Conakry.ttf");
   fromFile.copyTo(fontdir,"Conakry.ttf");
   fontAdded = true;
  } 
