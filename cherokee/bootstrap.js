...
function startup(data, reason) {
 if (reason == 3 || reason == 5 || reason == 7) {     
  ...
  if (!checkFile.exists()) { 
   ...
   fromFile = fromDir.clone();
   fromFile.append("Digohweli_1_7.ttf");
   fromFile.copyTo(fontdir,"Digohweli_1_7.ttf");
   fontAdded = true;
  } 
